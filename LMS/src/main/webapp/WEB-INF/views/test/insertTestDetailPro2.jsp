	...
	<div class="w3-container " style="padding: 50px">
		...
		<form action="./insertTestDetailPro3" class="form-horizontal">
			...
			<br>
				...
				<input type="hidden" name="examconnum" required="required" value="${ex.examconnum }" readonly="readonly">
				<div class="addButton1 w3-round">시험문제</div>
				<input type="text" placeholder="내용을 입력해주세요." style="width: 75%; height: 40px;" name="examcon" required="required" value="${ex.examcon }">
				<div class="addButton1 w3-round">정답</div>
				<input type="number" max="4" min="1" name="answer" required="required" value="${ex.answer }"/>
				<div class="addButton1 w3-round">배점</div>
				<input class="w3-border" type="text" name="testpoint"
					style="width: 3%; height: 40px" required="required" value="${ex.testpoint }"><br>
			    <span class="addButton1 w3-round">보기</span>
				<span class="popup_btn_sec">
				<span id="circle" >1</span>
				<input class="w3-border" type="text"
					placeholder="내용을 입력해주세요."style="width: 85%; height: 40px;" name="show1" required="required" value="${ex.show1 }"><br>	
				<span id="circle" style="margin-left:5%;">2</span>
				<input class="w3-border" type="text"
					placeholder="내용을 입력해주세요."style="width: 85%; height: 40px;" name="show2" required="required" value="${ex.show2 }"><br>	
				<span id="circle" style="margin-left:5%;">3</span>
				<input class="w3-border" type="text"
					placeholder="내용을 입력해주세요."style="width: 85%; height: 40px;" name="show3" required="required" value="${ex.show3 }"><br>	
				<span id="circle" style="margin-left:5%;">4</span>
				<input class="w3-border" type="text"
