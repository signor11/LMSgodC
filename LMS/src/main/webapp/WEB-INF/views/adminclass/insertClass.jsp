		...
		<form action="./insertClass" method="POST" name="pro_Form"
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" name="classname" id="classname" size="18"
						maxlength="12" class="form" style="text-transform: uppercase;" />
			...
			<div align="center">
				<input type="button" id="btn_insert" value="등록"
					class="btn btn-danger"> <input type="reset" id="btn_cancel"
					value="취소" onclick="javascript:redo();" class="btn btn-danger">
			</div>
