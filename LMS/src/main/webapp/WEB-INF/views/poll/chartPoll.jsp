...
google.setOnLoadCallback(function(){
	var chart_data = [['answer','answercnt']];
	$.ajax({
		...
		success : function(res_data){
			...
			var chart = new google.visualization.PieChart(document
						...
						chart.draw(google.visualization.arrayToDataTable(chart_data),
								options);
						var list1 = res_data['3']
						for (i = 0; i < list1.length; i++) {
							var answerNm = list1[i].answer;
							var cnt = list1[i].answercnt;
							var temp = [ answerNm, parseInt(cnt) ];
...
<body>
<h3 align="center">설문 조사 차트 </h3>
<br>
<div align="center">

1. 전체적으로 수업내용이 체계적으로 구성되었다.
<div id="chart_div1"></div>
2.강의내용은 해당분야의 지식을 습득하는데 도움이 되었다.
