...
public class SubmitHWController {
	...
	public String submitHWInsert(SubmitHWVO vo, HttpSession session, HttpServletRequest request)
	...
	public String submitHwUpdate(SubmitHWVO vo, HttpSession session, HttpServletRequest request)
			throws IllegalStateException, IOException {
		MultipartHttpServletRequest multipartRequest = (MultipartHttpServletRequest) request;
		MultipartFile file = multipartRequest.getFile("tempuploadfile");
